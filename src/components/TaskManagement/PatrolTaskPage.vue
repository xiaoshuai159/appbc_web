<template>
  ...
  <div class="operator-div">
    ...
    <div style="display: block;">
      <el-button type="primary" @click="startTaskByList" style="width: 100px">批量启动</el-button>
  ...
  <div class="shadow-div">
    <div class="base_table">
      <el-table v-loading="tableDataLoading" element-loading-text="数据加载中" element-loading-spinner="el-icon-loading"
          ...
          <el-table-column prop="remark" label="备注" :show-overflow-tooltip="true" min-width="90">
          </el-table-column>
          <el-table-column label="操作" width="220" fixed="right">
            <template slot-scope="scope">
              <el-button class="operator-table-btn green" style="border-right: 2px solid #cecece;padding-right:10px" type="warning" size="mini" @click="startTask(scope.row.id)"
                :disabled="scope.row.status != 0">启动</el-button>
                <el-button class="operator-table-btn red" style="border-right: 2px solid #cecece;padding-right:10px" type="danger" size="mini" @click="deleteTask(scope.row.id)"
                >删除</el-button> 
              ...
              <el-button class="operator-table-btn blue" type="primary" size="mini" @click="goResult(scope.row)"
                >详情</el-button>
            </template>
          </el-table-column>
        </el-table>
...
methods: {
  ...
  async deleteTaskByList() {
    ...
    this.$confirm("此操作将删除该任务, 是否继续?", "提示", {
      ...
      .then(async () => {
        const { data: res } = await this.$http.post(
          "/apkSeekerTask/delete?id=" + this.ids
        );
